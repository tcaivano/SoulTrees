        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemId3 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Trees_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Trees_Items_ItemId1",
                        column: x => x.ItemId1,
                        principalTable: "Items",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Trees_Items_ItemId2",
                        column: x => x.ItemId2,
                        principalTable: "Items",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Trees_Items_ItemId3",
                        column: x => x.ItemId3,
                        principalTable: "Items",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Skills_TreeId",
                table: "Skills",
                column: "TreeId");

            migrationBuilder.CreateIndex(
                name: "IX_Trees_ItemId",
                table: "Trees",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Trees_ItemId1",
                table: "Trees",
                column: "ItemId1");

            migrationBuilder.CreateIndex(
                name: "IX_Trees_ItemId2",
                table: "Trees",
                column: "ItemId2");

            migrationBuilder.CreateIndex(
                name: "IX_Trees_ItemId3",
                table: "Trees",
                column: "ItemId3");
        }
